...
export CESM_CASE_NAME=clm4_nldas_rcp45
...
ls -l ${INPUTDATA_DIR}/user_inputdata/nldas2_forcing/clmforc_rcp45/*.nc | awk '{ print $9}' | awk -F'.' '{print $3}' | \
awk -v INPUTDATA_DIR=${INPUTDATA_DIR} -v CLM_USRDAT_NAME=${CLM_USRDAT_NAME} \
'{ system( "ln -s " INPUTDATA_DIR "/user_inputdata/nldas2_forcing/clmforc_rcp45/clmforc.nldas." $1 ".nc " INPUTDATA_DIR"/cesm_inputdata/atm/datm7/"CLM_USRDAT_NAME"/clmforc.nldas." $1 ".nc") }'
